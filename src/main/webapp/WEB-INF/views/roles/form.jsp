...
<head>
    ...
    <title>
        <c:choose>
            <c:when test="${role.id != null}">Edit Role</c:when>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1>
                ...
                <c:choose>
                    <c:when test="${role.id != null}">Edit Role</c:when>
                    <c:otherwise>Add New Role</c:otherwise>
                </c:choose>
            </h1>
        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                    ...
                    <div class="card-body">
                        <c:choose>
                            <c:when test="${role.id != null}">
                                <c:set var="formAction" value="${pageContext.request.contextPath}/roles/${role.id}" />
                            </c:when>
                            <c:otherwise>
                                <c:set var="formAction" value="${pageContext.request.contextPath}/roles" />
                            </c:otherwise>
                        </c:choose>
                        ...
                        <form action="${formAction}" method="post">
                            <div class="mb-4">
                                ...
                                <div class="form-text">
                                    Enter a unique name for the role (2-50 characters)
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control ${not empty bindingResult && bindingResult.hasFieldErrors('description') ? 'is-invalid' : ''}" 
                                          ...
                                          placeholder="Enter role description (optional)">${role.description}</textarea>
                                ...
                                <div class="form-text">
                                    Provide a brief description of the role and its responsibilities (up to 200 characters)
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    ...
                                    <c:choose>
                                        <c:when test="${role.id != null}">Update Role</c:when>
                                        <c:otherwise>Create Role</c:otherwise>
                                    </c:choose>
                                </button>
                            </div>
                        </form>
                ...
                <div class="card mt-4">
                    ...
                    <div class="card-body">
                        <ul class="mb-0">
                            ...
                            <li>Roles can be assigned to multiple employees</li>
                            <li>Each employee must have at least one role assigned</li>
                            <li>You cannot delete a role that is assigned to employees</li>
                ...
                <div class="card mt-4">
                    <div class="card-header">
                        <h6 class="card-title mb-0">
                            <i class="fas fa-lightbulb"></i> Role Examples
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h6>Administrative Roles:</h6>
