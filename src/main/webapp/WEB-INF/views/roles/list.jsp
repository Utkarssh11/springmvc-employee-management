...
<head>
    ...
    <title>Roles - Employee Management System</title>
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1><i class="fas fa-tags"></i> Roles</h1>
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/roles/search" method="get" class="row g-3">
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="name" 
                               value="${searchName}" placeholder="Search roles by name...">
                    </div>
                    <div class="col-md-4">
        ...
        <c:choose>
            <c:when test="${empty roles}">
                <div class="text-center p-5">
                    ...
                    <p class="text-muted">Create your first role to assign to employees.</p>
                    <a href="${pageContext.request.contextPath}/roles/new" class="btn btn-primary">
                                        ...
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                            ...
                                            <c:choose>
                                                <c:when test="${role.employees.size() > 0}">
                                                    <button class="btn btn-sm btn-outline-danger" disabled title="Cannot delete role with employees">
                        ...
                        <div class="row text-center">
                            <div class="col-md-4">
                                <div class="border-end">
                                    <h4 class="text-primary">${roles.size()}</h4>
                            ...
                            <div class="col-md-4">
                                <div class="border-end">
                                    <h4 class="text-success">
                                        ...
                                        <c:forEach var="role" items="${roles}">
                                            <c:set var="totalAssignments" value="${totalAssignments + role.employees.size()}" />
                                        </c:forEach>
                                        ${totalAssignments}
                                    </h4>
                            ...
                            <div class="col-md-4">
                                <h4 class="text-warning">
                                    <c:set var="unassignedRoles" value="0" />
                                    <c:forEach var="role" items="${roles}">
                                        <c:if test="${role.employees.size() == 0}">
                                            <c:set var="unassignedRoles" value="${unassignedRoles + 1}" />
                                        </c:if>
                                    </c:forEach>
                                    ${unassignedRoles}
                                </h4>
                                <p class="text-muted mb-0">Unassigned Roles</p>
                            </div>
                        </div>
                    </div>
                </div>
